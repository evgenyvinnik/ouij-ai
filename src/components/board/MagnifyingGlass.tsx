  ...
  return (
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <div className={`relative flex h-10 w-10 items-center justify-center transition-opacity duration-300 ${
        ...
        {/* Outer glow */}
        <div className={`absolute inset-0 rounded-full bg-ouija-gold blur-md ${
        ...
        <div className="relative h-8 w-8 rounded-full border-2 border-ouija-gold bg-black/50 backdrop-blur-sm">
          ...
          {/* Center point */}
          <div className={`absolute left-1/2 top-1/2 h-1.5 w-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-ouija-gold ${
